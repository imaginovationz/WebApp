...
const checkIsAdmin = async (userid, password) => {
  try {
    const response = await axios.post(`${functionalfrontendconfig.backendUrl}/validate-admin`, { userid, password });
    ...
    <form onSubmit={onResourceSubmit} className="resource-form">
      ...
      <div className="form-row">
        <div className="form-column">
          ...
          <select name="title" value={resourceData.title} onChange={handleResourceChange} required>
            <option value="sr_automation_lead">Automation Architect</option>
            <option value="director">Director</option>
            <option value="sr_automation_engineer">Automation Engineer</option>
                      {/* <option value="se_quality_lead">Sr Quality Lead</option> */}
            <option value="sr_function_load">Sr.Test Coordinator</option>
            <option value="fuctional_tester">Test Coordinator</option>
            <option value="quality_engineer">Quality Engineer</option>
                      {/* <option value="developer">Developer</option> */}
                      {/* <option value="vp">VP</option> */}
            <option value="quality_analyst">QE Test Analyst</option>
      ...
      <div className="form-row">
        <div className="form-column">
          ...
          <select name="reporting_manager" value={resourceData.reporting_manager} onChange={handleResourceChange}>
            <option value="">Select Manager</option>
            <option value="Ellaine">Elaine Zhong</option>
            <option value="Nick">Nick Mendrul</option>
            <option value="Sourabh">Sourabh Shrivastava</option>
