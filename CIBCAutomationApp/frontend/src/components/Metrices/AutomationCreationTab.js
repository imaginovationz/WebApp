...
// = New: local CSS (scoped) for bordered, professional tables + vertical tabs
const styles = `
...
// = Table renderer with per-cell keys (so each cell can later fetch its own SQL)
