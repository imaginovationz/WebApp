...
const dashboards = [
  {
    ...
    iframeSrc:
      'https://app.powerbi.com/reportEmbed?reportId=05424048-c893-44f3-ad13-8671bdf4f6f8&autoAuth=true&ctid=222fcaf7-15d0-455f-97e1-8fda2eaad539&actionBarEnabled=true&reportCopilotInEmbed=true',
    buttons: [
  ...
  },
  {
    ...
    iframeSrc:
      'https://app.powerbi.com/reportEmbed?reportId=867accde-f605-440d-838b-103572e4b553&autoAuth=true&ctid=222fcaf7-15d0-455f-97e1-8fda2eaad539&actionBarEnabled=true&reportCopilotInEmbed=true',
    buttons: [
      { label: 'Update Selected', onClick: () => {} },
      { label: 'View Full Details of Selected', onClick: () => {} },
      { label: 'Download as PPT', onClick: () => {} },
...
const InitiativeDetails = () => {
  const [selectedDashboard, setSelectedDashboard] = useState('portfolio');
