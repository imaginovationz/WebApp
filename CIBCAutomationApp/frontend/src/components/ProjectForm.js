...
const ProjectForm = ({ projectData, handleProjectChange, handleProjectSubmit, releases, applications, resources, errorMessage }) => {
    ...
    <form onSubmit={handleProjectSubmit} className="project-form">
      ...
      <div className="form-row">
        ...
        <div className="form-column">
          ...
          <input type="date" name="intake_entry_date" value={projectData.intake_entry_date} onChange={handleProjectChange} required />
        </div>
      </div>
      <div className="form-row">
        <div className="form-column">
        ...
        <div className="form-column">
          ...
          <select type="text" name="project_status" value={projectData.project_status} onChange={handleProjectChange} >
            ...
            <option value="Discovery_SWAG">Active - Discovery/pre kickoff</option>
            <option value="Kick">Active - Project Kick Off</option>
            <option value="BRD_SRD">Active - BRD/SRD</option>
            <option value="Design">Active - Solution / Design</option>
            <option value="Construction">Active - Construction</option>
            <option value="DIT">Active - DIT</option>
            <option value="SIT">Active - SIT</option>
            <option value="UAT">Active - UAT</option>
      ...
      <div className="form-row">
        <div className="form-column">
          ...
          <select type="text" name="change_type" value={projectData.change_type} onChange={handleProjectChange} required>
            <option value=""></option>
