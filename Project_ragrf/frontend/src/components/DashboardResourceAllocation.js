...
const DashboardResourceAllocation = () => {
  ...
  return (
    <div className="dashboard-resource-allocation">
      <h1>Intake-Resource Dashboard</h1>
      {loading ? (
        ...
        <div className="charts-container">
          <div className="chart-column">
            <div className="form-type-row">
              ...
              <div><label>Select Intake: </label>
              </div>
              <div><select className="select-form-type-row"  id="intake" value={selectedIntake} onChange={handleIntakeChange}>
...
export default DashboardResourceAllocation;