...
port = config.get('port', 3003) # if port is no t passed use 5000
alm_port = config.get('alm_port', 3004) # if port is no t passed use 5000
mmtg_parser_port = config.get('mmtg_parser_port', 3005) # if port is no t passed use 5000
jenkins_port = config.get('jenkins_port', 3006) # if port is no t passed use 5000
